    ...
    <asp:DataList ID="points" runat="server"  Font-Size="9pt" >
        <ItemTemplate>
            <table cellpadding="0" cellspacing="0" style="width: 950px">
                <tr>
                    <td style="width:25px"><asp:Label ID="Label10" runat="server" Font-Size="9pt"  Text='<%# DataBinder.Eval(Container.DataItem,"real_name") %>'></asp:Label></td>
        ...
        <HeaderTemplate>
            <table>
                <tr>
                    ...
                    <td style="width:45px"><asp:Literal runat="server" Text="<%$ Resources:value%>" /></td>
                </tr>
            </table>
        </HeaderTemplate>
    </asp:DataList> 
